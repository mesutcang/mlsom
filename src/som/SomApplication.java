...
public class SomApplication extends ApplicationFrame {
	public SomApplication(String title) {
       ...
       // populateData();
        ...
        final JFreeChart chart = new JFreeChart("ML-SOM", plot);
//        chart.setLegend(null);
  ...
  //      panel.setHorizontalZoom(true);
	...
	public static void main(String[] args) {
		...
		a.setMap(12,12);
		a.setUpStreamMap(12,12);
		a.setNetwork(2,maxWeight);
		a.setConstantFunctionalFactor(0.8);
		a.parseData("iris.data");
		a.setLearningFunction(80,constantFactor);
		a.learn();
		...
		*/
		...
		for (int i = 0; i < neuronListSize; i++) {
			List list = a.upStreamTopologyGetConnectedNeurons(i);
		...
		final SomApplication graph = new SomApplication("Multi Layer Self Orginizing Maps");
		graph.pack();
